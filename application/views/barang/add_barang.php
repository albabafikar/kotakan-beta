  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2><a href="<?= $this->adminSite ?>item"><span class="fa fa-chevron-left"></span></a>&nbsp;Form Tambah Menu</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-horizontal form-label-left" method="post" novalidate action="<?= $this->adminSite ?>do_action?method=add_barang" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="" class="form-control col-md-7 col-xs-12" name="harga_satuan"  required type="text" autocomplete="off" />
                </div>
              </div>
              <div class="item form-group">
