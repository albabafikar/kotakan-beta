                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <input type="text" class="datepicker form-control" placeholder="<?= rand(1,31).'/'.rand(1,12).'/2018' ?>" name="tanggal_kirim" required autocomplete="off" />
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                <label>Jam Kirim:<span style="color:#fc0505">&nbsp;*</span></label>
                                                <input type="text" class="form-control" placeholder="<?= rand(1,12) ?>" name="jam_kirim" autocomplete="off" required />
                                            </div>
                                        </div>
                                        <div class="form-group">
