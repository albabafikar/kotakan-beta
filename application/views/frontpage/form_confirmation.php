            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row cart-body">
                        <form class="form-horizontal" method="post" action="<?= base_url() ?>do_action?method=accept_order">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="checkbox">
                                          <label><input type="checkbox" name="agree" value="yes">Ya, Saya setuju</label>
                                        </div>
