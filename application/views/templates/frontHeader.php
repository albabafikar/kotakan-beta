...
<body>
    ...
    <div id="wrapper">
        ...
        <!--nav class="hidden-xs cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
            ...
            <ul>
                <li>
                    <img src="<?= base_url() ?>resources/upload//item_01.jpg" alt="" class="alignleft img-responsive">
                ...
                <li>
                    <img src="<?= base_url() ?>resources/upload//item_02.jpg" alt="" class="alignleft img-responsive">
                ...
                <li>
                    <img src="<?= base_url() ?>resources/upload//item_03.jpg" alt="" class="alignleft img-responsive">
                ...
                <li>
                    <img src="<?= base_url() ?>resources/upload//item_04.jpg" alt="" class="alignleft img-responsive">
